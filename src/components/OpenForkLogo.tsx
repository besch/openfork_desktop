...
export function OpenForkLogo({ className, size = 20 }: LucideProps) {
  return (
    <svg 
      width={size} 
      height={size} 
    ...
    >
      ...
      />
      <path 
        d="M42 82H58V50C58 45.5817 54.4183 42 50 42C45.5817 42 42 45.5817 42 50V82Z" 
        fill="currentColor"
      />
      <path 
        ...
        fill="currentColor"
      />
      <rect x="42" y="7" width="16" height="35" rx="8" fill="currentColor"/>
    </svg>
  );
}
