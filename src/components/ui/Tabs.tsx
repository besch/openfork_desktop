...
const TabsTrigger = ({ value, activeTab, setActiveTab, children, className, ...props }: TabsTriggerProps) => {
...
const TabsContent = ({ value, activeTab, children, className }: TabsContentProps) => {
