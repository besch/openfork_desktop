    ...
    >
      <defs>
        ...
        <mask id="logo-mask-desktop">
          <path fillRule="evenodd" clipRule="evenodd" d="M50 160C72.0914 160 90 142.091 90 120C90 97.9086 72.0914 80 50 80C27.9086 80 10 97.9086 10 120C10 142.091 27.9086 160 50 160ZM50 142C62.1503 142 72 132.15 72 120C72 107.85 62.1503 98 50 98C37.8497 98 28 107.85 28 120C28 132.15 37.8497 142 50 142Z" fill="white"/>
