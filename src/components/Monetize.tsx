...
export function Monetize() {
  ...
  const handleWithdraw = useCallback(async () => {
    ...
    const amount = Math.floor(monetizeWallet.available_to_withdraw_millicents);
        ...
        {[
          {
            ...
            value: wallet
              ? formatMillicents(wallet.pending_earnings_millicents)
              : "—",
          ...
          },
          {
            ...
            value: wallet
              ? formatMillicents(wallet.total_withdrawn_millicents)
              : "—",
            color: "text-muted/60",
          },
        ].map((item, i) => (
